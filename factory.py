...
def create_app():
    ...
    # =========================================================
    # [MỚI] 1. KÍCH HOẠT CSRF PROTECTION TOÀN CỤC
    # =========================================================
    csrf.init_app(app)
    
    # Bỏ qua CSRF cho các webhook hoặc API nội bộ nếu cần (Ví dụ chatbot)
    # csrf.exempt('blueprints.chat_bp.api_webhook_endpoint')
